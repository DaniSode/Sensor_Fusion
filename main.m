...
cov_acc = [cov(acc_data(1, ~isnan(acc_data, 1))), cov(acc_data(2, ~isnan(acc_data, 1))), cov(acc_data(3, ~isnan(acc_data, 1)))];
cov_gyro = [cov(gyro_data(1, ~isnan(gyro_data, 1))), cov(gyro_data(2, ~isnan(gyro_data, 1))), cov(gyro_data(3, ~isnan(gyro_data, 1)))];
cov_mag = [cov(mag_data(1, ~isnan(mag_data, 1))), cov(mag_data(2, ~isnan(mag_data, 1))), cov(mag_data(3, ~isnan(mag_data, 1)))];
